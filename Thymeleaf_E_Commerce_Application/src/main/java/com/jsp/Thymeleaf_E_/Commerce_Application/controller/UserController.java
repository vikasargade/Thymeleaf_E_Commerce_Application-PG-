...
public class UserController {
	...
	public ApplicationResponse<User> registerUser(@RequestBody User user) {
		...
		ApplicationResponse<User> applicationResponse = new ApplicationResponse("USER ADDED SUCCESSFULLY",
...
//	}
	...
	public ApplicationResponse<User> getAllUsers() { // to fecth all users
		...
		ApplicationResponse<User> applicationResponse = new ApplicationResponse<User>("RECORDS FOUND", HttpStatus.FOUND,
				LocalDateTime.now(), listOfUser);
	...
	public ApplicationResponse<User> getUserById(@PathVariable int id) { // to get user by id
		...
		if (user != null)
			...
			return new ApplicationResponse("USER NOT FOUND", HttpStatus.NOT_FOUND, LocalDateTime.now(), user);
	}
	...
	public ApplicationResponse<User> getUserByEmailAndPass(@PathVariable String email, @PathVariable String pass) {
		...
		ApplicationResponse<User> applicationResponse = new ApplicationResponse<User>("RECORD FOUND", HttpStatus.FOUND,
	...
	public ApplicationResponse<User> updateUserById(@RequestBody User user) { // to update the user's information
		...
		ApplicationResponse<User> applicationResponse = new ApplicationResponse<User>("USER UPDATED SUCCESSFULLY",
				HttpStatus.ACCEPTED, LocalDateTime.now(), updatedUser);
		return applicationResponse;
	}
	...
	public ApplicationResponse<User> deleteUserById(@PathVariable("id") int id) {
		...
		ApplicationResponse<User> applicationResponse = new ApplicationResponse<User>("RECORD DELETED",
				HttpStatus.NO_CONTENT, LocalDateTime.now()); // enum for delete
		return applicationResponse;
	}
